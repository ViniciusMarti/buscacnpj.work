...
try {
    ...
    // Nota: Em MySQL, índices compostos e tipos de dados corretos são fundamentais.
    $queries = [
    ...
    foreach ($queries as $sql) {
        ...
        try {
            ...
            echo "<span style='color:orange'>Aviso (já existente ou erro leve): " . $e->getMessage() . "</span><br>";
        }
        flush();
    }

    echo "<h2>✅ Otimização Concluída!</h2>";
    echo "<p>Agora as buscas por CNPJ e os Rankings no MySQL serão rápidos.</p>";
